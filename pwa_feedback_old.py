...
#			G.remove_nodes_from(obstacle_nodes)
	...
	def find_triangle(self,p):
		...
		if tuple(E(self.prev_elem,current_triangle)) in self.hysteresis_transitions:
...
if __name__ == '__main__':
	...
	curr_triangle, = plot([0],[0],'b-')
	curr_node, = plot([0],[0],'g-')
	print "Draw quiver..."
